...
func TestBuildSearchQuery_DisabledConfig(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), history, "How much?", nil, cfg)
...
func TestBuildSearchQuery_NoEndpoint(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), nil, "test query", routerCfg, cfg)
	require.NoError(t, err)
...
func TestBuildSearchQuery_NilConfig(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), nil, "test query", nil, nil)
	require.NoError(t, err)
...
func TestBuildSearchQuery_WithMockLLM(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), history, "How much?", routerCfg, cfg)
	require.NoError(t, err)
...
func TestBuildSearchQuery_SelfContainedQuery(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), nil, "What is the capital of France?", routerCfg, cfg)
	require.NoError(t, err)
...
func TestBuildSearchQuery_LLMError_FallbackToOriginal(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), nil, "original query", routerCfg, cfg)
...
func TestBuildSearchQuery_CleanupQuotes(t *testing.T) {
	...
	result, err := BuildSearchQuery(context.Background(), nil, "How much?", routerCfg, cfg)
	require.NoError(t, err)
