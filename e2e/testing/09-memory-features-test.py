...
Organized by priority derived from risk/return analysis:
...
class PerDecisionMemoryDisabledTest(MemoryFeaturesTest):
    ...
    def test_01_disabled_decision_skips_memory_retrieval(self):
        ...
        # Step 2: Wait for extraction and verify prerequisite
        self.wait_for_extraction()
        ...
        # Echo backend: if memory was injected, "google" would appear in response
        ...
        # Step 4: Control — same query via default_route (no marker → memory enabled)
