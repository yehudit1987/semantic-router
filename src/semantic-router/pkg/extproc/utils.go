...
// extractChatCompletionUserID extracts the "user" field from Chat Completions request.
// This is an optional field in the OpenAI API for end-user identification.
func extractChatCompletionUserID(requestBody []byte) string {
	var req struct {
