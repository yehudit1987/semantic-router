...
class MMLU_Dataset:
    ...
    def _load_supplement_data(self) -> list:
        ...
        try:
            ...
            # Get the train split
            data = supplement["train"] if "train" in supplement else supplement[list(supplement.keys())[0]]
    ...
    def load_huggingface_dataset(self):
        ...
        try:
            ...
            # Load and merge supplementary training data from HuggingFace (if provided)
